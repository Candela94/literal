...
import './cartmenu.css'
import { HeaderCarritoDesk } from '../../components/header/Header';
...
export const CarritoMenu = ({opened, onClose}) => {
  ...
  return (
    ...
    <div className={`Menu-lateral ${opened ? 'opened' : ''}`} ref={menuRef}>
        <HeaderCarritoDesk onClose={onClose}/>
      ...
      <footer className="Footer-cartDesk">
  {!estaVacio && (
    <>
